...
* 1) Utilize default write barrier/card table mechansm to record the object assignement in Region Space. 
* 2) Utilize minorGC to move elements into corresponding RDDTlab_entry && add un-moved field's addr into RDDTlab->_ref_queue.
*
* Structure:
* Big data array.
...
public class SparkCase27 {
  ...
  public static void region_loop(int loop_num) {
    ...
    objItem[] disturb_array = new objItem[257];             
    //debug
//    System.out.println("disturb_array.leng "+ disturb_array.length);
    ...
    do{ 
      ...
      // do aastore
      for(int i= count*_small_elem_num, j=0; i< (count+1)*_small_elem_num; i++,j++ ){
