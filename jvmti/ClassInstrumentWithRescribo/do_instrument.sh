...
LD_LIBRARY_PATH=`pwd`:${LD_LIBRARY_PATH} gdb --args /mnt/ssd/haoran/jdk12u-dev/build/linux-x86_64-server-slowdebug/jdk/bin/java ${LogInfo} -agentlib:${JVMTILib} ${JavaApp}
