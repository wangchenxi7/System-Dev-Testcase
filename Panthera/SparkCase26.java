...
/*
* Test path:
* Test field addr recording mechanism.
* Utilize Interpreter/C1/C2 to insert all the field addr into RDDTlab_entry->_ref_queue
* Utilize minorGC to update field addr in RDDTlab_ref_queue.
*
* Structure:
* Big data array.
...
* 
*
* KeyPoint : obj.field --> obj
* a. Record mutator field addr record via Interpreter/C1/C2
* b. Update RDDTlab->_ref_queue by minorGC.
* c. Do Element Gathering via minorGC.
*
