#include "stdio.h"
//#include <linux/log2.h>  // how to invoke functions in header ?
...
int main(int argc, char* argv[]){
    ...
    //uint64_t gb_offset;
    printf("Self defind function, power_of_2: \n");
    ...
    printf("kernel API, ilog2(): \n");
    printf("offset for CHUNK_SIZE_GB_1 : %d \n", 30 + ilog2(CHUNK_SIZE_GB_1) );
    printf("offset for CHUNK_SIZE_GB_2 : %d \n", 30 + ilog2(CHUNK_SIZE_GB_2) );
    printf("offset for CHUNK_SIZE_GB_4 : %d \n", 30 + ilog2(CHUNK_SIZE_GB_4) );
